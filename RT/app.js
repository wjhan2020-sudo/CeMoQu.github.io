...
function trial_sara_score(final_dist_cm, reaction_time_s, missed){
  ...
  if(final_dist_cm !== null && final_dist_cm < 3.0 && reaction_time_s !== null && reaction_time_s < 2.0) return 0;
  if(final_dist_cm !== null && final_dist_cm >= 3.0 && final_dist_cm < 7.0) return 1;
  if(final_dist_cm !== null && final_dist_cm >= 7.0 && final_dist_cm < 15.0) return 2;
  if(final_dist_cm !== null && (final_dist_cm >= 15.0 || (reaction_time_s !== null && reaction_time_s > 4.0))) return 3;
  return 1;
}
